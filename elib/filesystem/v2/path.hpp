#ifndef ELIB_FILESYSTEM_V2_PATH_HPP
#define ELIB_FILESYSTEM_V2_PATH_HPP

# include <elib/filesystem/v2/config.hpp>
# include <elib/filesystem/v2/detail/path_converter.hpp>
...
#endif /* ELIB_FILESYSTEM_V2_PATH_HPP */